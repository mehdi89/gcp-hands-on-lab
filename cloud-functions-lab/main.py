def wpdev_fireworks(request):
    ...
    <h1 style='padding-top:100px;font-size:48px;color:white;text-align:center;'>Hello Cloud Function<br>
        <img src='https://raw.githubusercontent.com/mehdi89/gcp-hands-on-lab/main/assets/wpdev.png' alt='WPDeveloper'></h1>
    <div class='demo'>
    </div>
